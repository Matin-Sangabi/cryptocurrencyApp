...
const OverViewSection = () => {
  ...
  if(globalStatsMarket){
    return (
    <div className="p-2 mb-24 md:mb-0 col-span-12 lg:col-span-3 xl:col-span-3 bg-blue-50 shadow-md shadow-blue-200 rounded-2xl my-2">
      ...
      <div className="grid grid-cols-12 items-center gap-2 pt-4 h-auto lg:h-[300px]  lg:overflow-auto ">
        {globalStatsMarket ? (
          <>
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              <h1 className="text-slate-500 text-sm">total</h1>
              <span className="py-2 w-32 lg:w-36 xl:w-24 2xl:w-32  font-semibold text-sm px-4 bg-blue-500  shadow-lg  text-center rounded-lg text-white">
            ...
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              <h1 className="text-slate-500 text-sm">total</h1>
              <span className="py-2 w-32 lg:w-36 xl:w-24 2xl:w-32  font-semibold text-sm px-4 bg-yellow-700  shadow-lg  text-center rounded-lg text-white">
            ...
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              <h1 className="text-slate-500 text-sm">total</h1>
              <span className="py-2 w-32 lg:w-36 xl:w-24 2xl:w-32  font-semibold text-sm  bg-indigo-500  shadow-lg  text-center rounded-lg text-white">
            ...
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              <h1 className="text-slate-500 text-sm">total</h1>
              <span className="py-2 w-32 lg:w-36 xl:w-24 2xl:w-32   font-semibold text-xs flex justify-center px-4 bg-indigo-500  shadow-lg  rounded-lg text-white">
            ...
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              <h1 className="text-slate-500 text-sm">total</h1>
              <span className="py-2 w-32 flex justify-center lg:w-36 xl:w-24 2xl:w-32  font-semibold text-sm px-4 bg-blue-500  shadow-lg  text-center rounded-lg text-white">
            ...
            <div className="col-span-6 md:col-span-4 lg:col-span-12 mx-auto xl:col-span-6  p-2 bg-blue-50 shadow-lg shadow-blue-200 rounded-xl border flex flex-col gap-y-4 items-center">
              ...
              <span className="py-2 w-32 lg:w-36 xl:w-24 2xl:w-32  font-semibold px-4 bg-yellow-700  shadow-lg  text-center rounded-lg text-white">
                $
                {numberWithCommas(
