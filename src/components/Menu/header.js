      ...
      <nav className="w-full flex items-center justify-between">
        ...
        <div className="flex-1 flex items-center justify-end">
          ...
          <div className="w-96 relative">
            <span className="text-slate-500 absolute top-3 text-2xl stroke-2 left-1"><IoSearchOutline/></span>
            <input type="text" className="py-3 px-8 bg-blue-50 rounded-xl w-full ring-2 ring-blue-50 border-none transition-all ease-in-out duration-300 outline-none focus:ring focus:ring-blue-500 " placeholder="Search"/>
          </div>
            ...
            <div className="flex items-center gap-x-2">
              <span className="w-10 h-10 rounded-full bg-blue-200 ring-2 ring-blue-400"></span>
